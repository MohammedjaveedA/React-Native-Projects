...
const home = () => {
  ...
  const handleDestinationPress=(location:{
    ...
    router.push("//find-ride") //i should check whether this works or not
  }
  useEffect(() => {
  ...
  ListHeaderComponent={
    ...
    <TouchableOpacity onPress={onsignoutpress} className='w-10 h-10 justify-center items-center rounded-full bg-white' >
