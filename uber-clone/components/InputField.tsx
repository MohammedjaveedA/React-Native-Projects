import { View, Text, KeyboardAvoidingView, TouchableWithoutFeedback, Image, TextInput, Keyboard, Platform } from 'react-native'
import React from 'react'
import { InputFieldProps } from '@/types/type'

const InputField = ({label,labelStyle,icon,secureTextEntry=false,inputStyle,containerStyle,iconStyle,className,...props}:InputFieldProps) => {
  return (
